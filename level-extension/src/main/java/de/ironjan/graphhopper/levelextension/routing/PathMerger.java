...
import de.ironjan.graphhopper.levelextension.routing.InstructionsFromEdges;
...
public class PathMerger extends com.graphhopper.util.PathMerger {
    ...
    public com.graphhopper.util.PathMerger setCalcPoints(boolean calcPoints) {
        this.calcPoints = calcPoints;
        return this;
    }

    public com.graphhopper.util.PathMerger setDouglasPeucker(DouglasPeucker douglasPeucker) {
        this.douglasPeucker = douglasPeucker;
        return this;
    }

    public com.graphhopper.util.PathMerger setPathDetailsBuilders(PathDetailsBuilderFactory pathBuilderFactory, List<String> requestedPathDetails) {
        this.pathBuilderFactory = pathBuilderFactory;
        this.requestedPathDetails = requestedPathDetails;
        return this;
    }

    public com.graphhopper.util.PathMerger setSimplifyResponse(boolean simplifyRes) {
        this.simplifyResponse = simplifyRes;
        return this;
    }

    public com.graphhopper.util.PathMerger setEnableInstructions(boolean enableInstructions) {
